...
public class Lighting {
    ...
    void SetupLights() {
        ...
        for(int i=0; i<visibleLights.Length; i++){
            ...
            if (l.lightType != LightType.Directional || l.light.bakingOutput.lightmapBakeType == LightmapBakeType.Baked) continue;
    ...
    void SetupDirectionalLight(int i, ref VisibleLight l){
        ...
        dirLightShadowData[i] = shadows.ReserveDirectionalShadows(l.light, i);        
    }
